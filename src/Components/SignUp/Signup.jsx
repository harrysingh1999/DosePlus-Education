...
//                 <label className="font-semibold text-gray-600" htmlFor="">
//                   Name
//                 </label>
//                 <input
//                   type="text"
...
//               <NavLink to="/Login">
//                 <button
//                   className="w-full  mt-6 bg-[#791b1bd3] text-white py-2 px-4 rounded hover:bg-[#791b1bfe] focus:outline-none
...
//             ) : (
//               <button
//                 className="w-full mt-6 bg-[#b40047] text-white py-2 px-4 rounded hover:bg-[#791b1bfe] focus:outline-none
//               focus:ring-2 focus:ring-red-500 mx-auto"
//               >
//                 Register
//               </button>
    ...
    <div className="min-h-screen flex justify-center md:mt-[90px] bg-gray-100 px-5">
      <div className=" w-full sm:w-auto mx-auto py-6">
        ...
        <div className="bg-white p-6 mb-5 rounded-xl shadow-md">
          <h2 className="text-xl md:text-2xl font-bold mb-6 sm:mx-52 md:mx-64 text-center text-[#b40047]">
            Sign Up
          </h2>
          {message && (
          ...
          {message === "Successfully signed up!" && (
            <div className="flex justify-center">
              <NavLink to="/Login">
                <button className="bg-red-400 rounded-lg text-white p-2 text-center mb-4">
                  {" "}
                  Go to Login{" "}
                </button>{" "}
              </NavLink>
          ...
          <form onSubmit={(e) => handleSubmit(e)}>
            ...
            <div className="flex justify-center mt-6">
              <button className="w-full text-sm md:text-base bg-[#791b1bd3] text-white py-2 px-4 rounded hover:bg-[#5a1515] focus:outline-none focus:ring-2 focus:ring-red-500">
                Register
              </button>
            </div>
          </form>
